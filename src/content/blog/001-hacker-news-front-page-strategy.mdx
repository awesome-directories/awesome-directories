---
title: "How to Get on Hacker News Front Page: Show HN Strategy (90% Fail Rate)"
description: "Complete Hacker News launch strategy with real traffic data (10,000-30,000 visitors). Learn the Show HN guidelines, best posting times, why 90% fail, and how the HN algorithm actually works. Includes conversion benchmarks."
date: 2025-11-21
tags:
  - hacker-news
  - show-hn
...
coverCaption: Man running up the hill - Photo by Bill Fairs on Unsplash
draft: false
...
**Browse our [curated directory of 300+ startup directories](/)** to find additional platforms for your product launch. If HN validates your product-market fit, systematic submission to vetted directories can multiply that initial momentum into sustained discovery.
...
Hacker News is one piece of a comprehensive launch strategy. Explore our other platform guides:

- **[Product Hunt Launch Strategy 2025](/blog/product-hunt-launch-guide-2025-algorithm-changes)** — Only 10% get featured, here's how to be one of them
- **[Reddit Marketing Strategy](/blog/reddit-marketing-account-warmup-time-investment)** — How much karma you need and the 42x engagement formula
- **[Indie Hackers Strategy](/blog/indie-hackers-launch-strategy-guide-2025)** — 23% conversion rate vs Product Hunt's 3%
- **[BetaList Launch Guide](/blog/betalist-launch-strategy-guide-2025)** — Pre-launch validation with $0.50-$1.40 cost per signup

<template>
  <div id="app" class="min-h-screen flex flex-col">
    ...
    <ChecklistModal v-if="showChecklistModal" @close="showChecklistModal = false" />
  </div>
</template>
...
provide('hideAuthModal', () => { showAuthModal.value = false })
provide('showChecklistModal', () => { showChecklistModal.value = true })
provide('hideChecklistModal', () => { showChecklistModal.value = false })

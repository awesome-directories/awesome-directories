            ...
            <div class="flex items-start space-x-3 mb-4">
              ...
              <div class="flex-1">
                ...
                <p class="text-sm text-gray-600">
                  Get a PDF checklist emailed to you with all {{ selectedCount }} directories.
                </p>
              </div>
            </div>
            ...
            <form @submit.prevent="handleDownloadChecklist" class="space-y-3">
              ...
              <label class="flex items-start space-x-2 text-sm">
                ...
                <span class="text-gray-700">
                  Subscribe to newsletter (new directories, launch tips, founder stories)
                </span>
              </label>
...
const handleDownloadChecklist = async () => {
  ...
  try {
    ...
    downloadSuccess.value = '✅ Checklist downloaded! Check your email for updates.'

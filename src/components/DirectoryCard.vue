<template>
  <article
    ...
    :class="{
      'ring-2 ring-yellow-400/50 border-yellow-300': isPendingSubmission,
    }"
  >
    <div
      v-if="isPendingSubmission"
      class="absolute top-0 left-0 right-0 bg-yellow-50 px-3 py-1.5 text-xs font-medium text-yellow-800 flex items-center gap-1.5 border-b border-yellow-200"
    >
    ...
    <div class="p-4 sm:p-5" :class="{ 'pt-10': isPendingSubmission }">
      <div class="flex items-start gap-3 sm:gap-4">
        <div class="flex-shrink-0">
          <div
            class="w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-gradient-to-br from-gray-100 to-gray-50 flex items-center justify-center overflow-hidden border border-gray-200"
          >
            <img
        ...
        <div class="flex-1 min-w-0">
          <div class="flex items-start justify-between gap-2">
            <div class="min-w-0">
              <h3
                class="font-semibold text-gray-900 text-base sm:text-lg leading-tight truncate group-hover:text-primary transition-colors"
              >
                {{ directory.name }}
              </h3>
        ...
        <div class="metric-card">
          ...
          <div class="flex items-baseline gap-1">
            ...
            <div
              ...
              class="w-full max-w-[40px] h-1.5 bg-gray-200 rounded-full overflow-hidden"
            >
              <div
      ...
      <div
        v-if="hasCategories"
        class="mt-3 flex items-center gap-1.5 flex-wrap"
      >
        <span
    ...
    >
      <div class="flex items-center gap-2 text-gray-600">
        ...
        <span
          >{{ formatNumber(directory.referring_domains) }} ref. domains</span
        >
      </div>

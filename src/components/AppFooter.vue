  ...
  <footer class="bg-gray-900 text-gray-300">
    <div class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        <!-- About Section -->
        <div>
          <h3 class="text-white font-bold text-lg mb-4">Awesome Directories</h3>
          <p class="text-sm text-gray-400 mb-4">
            Find the top 20 launch directories worth your time in under 3 minutes—curated, verified, and updated weekly.
          </p>
          <p class="text-sm text-gray-400">
            Built by <a href="https://meysam.io" target="_blank" rel="noopener" class="text-primary hover:text-primary-light transition-colors">Meysam</a>
          </p>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-2">
            <li>
              <router-link to="/about" class="text-sm text-gray-400 hover:text-white transition-colors">
                About
              </router-link>
            </li>
            <li>
              <router-link to="/submit" class="text-sm text-gray-400 hover:text-white transition-colors">
                Submit Directory
              </router-link>
            </li>
            <li>
              <router-link to="/stats" class="text-sm text-gray-400 hover:text-white transition-colors">
                Public Stats
              </router-link>
            </li>
            <li>

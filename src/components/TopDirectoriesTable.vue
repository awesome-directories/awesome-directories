<template>
  ...
  <div v-else class="grid grid-cols-1 lg:grid-cols-2 gap-6">
    ...
    <div class="card p-6">
      ...
      <div
        v-if="stats.topByVotes.length === 0"
        ...
        <table class="min-w-full divide-y divide-gray-200">
          <thead>
            <tr>
              ...
              <th
                class="px-3 py-2 text-right text-xs font-medium text-gray-500 uppercase tracking-wider hidden sm:table-cell"
              >
                Votes
              </th>
            </tr>
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            ...
            >
              ...
              <td
                class="px-3 py-3 whitespace-nowrap text-right hidden sm:table-cell"
              >
                <span
